...
public class PushToDatabaseTest {
    ...
    void initializeNeo4j() {
        this.embeddedDatabaseServer = Neo4jBuilders.newInProcessBuilder()
                .withDisabledServer()
                .withProcedure(PushToDatabase.class)
                .build();
    ...
    public void checkReturnStatement() {
        ...
        try(Session session = driver.session()) {
            ...
            Result result = session.run("MATCH (u:Person) CALL pushToDatabasePD(u) YIELD out RETURN out");
